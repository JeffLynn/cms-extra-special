...
Refinery::Pages.configure do |config|
  ...
  config.new_page_parts = true  # JL 2013.09.26 - Set to True to allow setting up page parts to match original extra-special application...

  # Configure global page default parts
  config.default_parts = ["Header Left", "Header Right", "Left Menu", "Main Photo", "Page Title", "Main Content Right", "Main Content Left"] # JL 2013.09.26 - ...and added them as defaults
